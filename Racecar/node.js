var activationsNames = ["Sigmoid", "Identity", "Step", "Tanh", "ReLu", "Cube"]; //Used in the svg drawing
...
class Node {
	constructor(num, lay, isOutput) {
		this.number = num;
		this.layer = lay;
		this.activationFunction = Math.floor(Math.random() * 6); //Number between 0 and 5
